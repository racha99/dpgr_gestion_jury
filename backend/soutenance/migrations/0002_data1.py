...
def create_data(apps, schema_editor):
   ...
   # Dossier(d_id=8, etat="A", lien="https://drive.google.com/drive/folders/1DWJMlNb0UTU0R6vPNbLRJq7rdzQcTDFo").save()
    ...
    Jury(j_id=1,nom="nom1",prenom="el haj",domaine_xp="securité infomatique",type='E',tel_num='0526897412',email="jury1@esi.dz").save()
    JuryStn(js_id=1,role='JU',jury_id=Jury(j_id=1,nom="nom1",prenom="el haj",domaine_xp="securité infomatique",type='E',tel_num='0526897412',email="jury1@esi.dz"),soutenance_id=  Soutenance(s_id=3, laureat_id=Laureat(l_id=3, nom="n3", prenom="p3", email="n3p3@gmail.com"), dossier_id=Dossier(d_id=3, etat="R", lien="https://drive.google.com/drive/folders/1DWJMlNb0UTU0R6vPNbLRJq7rdzQcTDFo"), theme="SQ", type="D", etat="R", sujet="sujet3")
  ).save()
    JuryStn(js_id=2,role='JU',jury_id=Jury(j_id=1,nom="nom1",prenom="el haj",domaine_xp="securité infomatique",type='E',tel_num='0526897412',email="jury1@esi.dz"),soutenance_id=  Soutenance(s_id=3, laureat_id=Laureat(l_id=3, nom="n3", prenom="p3", email="n3p3@gmail.com"), dossier_id=Dossier(d_id=3, etat="R", lien="https://drive.google.com/drive/folders/1DWJMlNb0UTU0R6vPNbLRJq7rdzQcTDFo"), theme="SQ", type="D", etat="R", sujet="sujet3")
  ).save()
